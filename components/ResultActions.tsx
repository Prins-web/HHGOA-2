...
export default function ResultActions({ onDownload, onShare, onReset }: ResultActionsProps) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row">
      <button onClick={onDownload} className="flex-1 rounded-[24px] bg-[#ffd83d] px-5 py-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#04251c]">Download Pass</button>
